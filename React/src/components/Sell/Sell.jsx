...
const Sell = () => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    try {
      let response = await axios.post('http://localhost:8000/api/products', values, {
        headers: {
      ...
      <div className={styles.sellPage}>
        ...
        <div className={styles.formGroup}>
          <label htmlFor="formFile" className={`${styles.label} ${formik.touched.images && formik.errors.images && styles.invalid} w-100 h-100`}>
            <span>Upload you images</span>
            <div className="d-flex align-items-center cursor-pointer ">
              <img
                src="https://www.dubizzle.com.eg/assets/iconAddPhoto_noinline.8924e2486f689a28af51da37a7bda6ec.svg"
                alt=""
              />
              <div className="c6a55a8c"></div>
            </div>
          </label>
          <input
